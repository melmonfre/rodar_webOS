...
import 'package:rodarwebos/pages/fotos/telas_fotos/foto_equipamento.dart';
...
class _FotoInstalacaoState extends State<FotoInstalacao> {
              ...
              AnexoEvidencias(
                ...
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => FotoEquipamento(),
                    ),
                  );
                },
              ),
