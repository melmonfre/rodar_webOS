...
class _CameraButtonState extends State<CameraButton> {
  ...
  return Padding(
    ...
    child: Row(
      ...
      children: [
        ...
        SizedBox(width: 5),
        BotaoCancelar(
          onPressed: _clearPicture, // Chama a função para limpar a imagem ao clicar no botão de cancelar
        ),
      ],
    ),
  );
  ...
  if (image != null) {
    ...
    base64File = ''; // Define um valor padrão para base64File caso não haja imagem.
    // Opcional: Salvar a string vazia no cache se não houver imagem, caso seja necessário.
    salvanocache(base64File);
  }
}
